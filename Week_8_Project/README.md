...
* When adding a new country, the form has three inputs: Name, Code, CountryId. CountryId is vulnerable to SQL Injection. I just used a single quote to figure it out. It threw an error : "Incorrect Integer value for column country_id at row 1",  "Data truncated for column country_id at row 1"
